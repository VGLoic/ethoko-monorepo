 ...
 * Additionally, pure type files with the ABI typings are emitted, organized by project, tag and contract, i.e. `abis/{project}/{tag}/{sourceName}/{contract}.d.ts`. These files are meant to be imported by the end-developer directly.
 * The `summary-exports.ts` contains the PROJECTS object that maps the project name to the contracts and tags.
 * ```ts
...
export const PROJECTS = {} as const;
  ...
  const emptyTypingsContent = `// THIS IS AN AUTOGENERATED FILE. EDIT AT YOUR OWN RISKS.
export interface Projects {}
  `;
  await fs.writeFile(`${ethokoTypingsPath}/projects.d.ts`, emptyTypingsContent);
