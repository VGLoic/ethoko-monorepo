 ...
 *
 * This script relies on typings generated by Soko for the project "forge-counter".
 * It is assumed that the tag `2026-02-04` exists in the Soko registry for this project.
 * It could have been created by running:
 * ```
 * npx hardhat soko push --tag 2026-02-04 --artifact-path ./out
 * ```
  ...
  async ({ deploy, namedAccounts }) => {
    ...
    await deploy("Counter", {
      ...
      artifact: {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        bytecode: counterArtifact.evm.bytecode.object as any,
        metadata,
      },
    });
  },
