...
describe("[Foundry Hardhat-deploy v2] - Compilation WITH --build-info WITH test and scripts - Push artifact, pull artifact, deploy - Hardhat Plugin", () => {
  ...
  testPushPullDeploy({
    ...
    outputArtifactsPath: BUILDS.WITH_BUILD_INFO_WITH_TEST.outputPath,
  });
});
