 ...
 *  - `npx ethoko pull ignited-counter:2026-02-02` to pull the project from the Ethoko registry,
 *  - `npx ethoko typings ignited-counter:2026-02-02` to generate the typings for the project.
 */
