 ...
 * ```
 * npx ethoko push doubtful-counter:v1.0.1 --artifact-path ./artifacts
 * ```
 * The assumed commands that have been run prior to this deployment are:
 *  - `npx ethoko pull doubtful-counter:v1.0.1` to pull the project from the Ethoko registry,
 *  - `npx ethoko typings doubtful-counter:v1.0.1` to generate the typings for the project.
 */
